...
import (
	...
	"github.com/altair-lab/xoreum/common/prque"
...
type Sync struct {
	database xordb.Reader             // Persistent database to check for existing entries
...
func NewSync(root common.Hash, database xordb.Reader, callback LeafCallback) *Sync {
	ts := &Sync{
		database: database,
...
func (s *Sync) Commit(dbw xordb.Writer) (int, error) {
